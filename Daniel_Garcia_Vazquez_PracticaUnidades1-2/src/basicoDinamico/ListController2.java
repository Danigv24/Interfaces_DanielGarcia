...
public class ListController2 {
    ...
    @FXML
    private TableColumn<Zapatilla, Integer> Stock;
    ...
    private ObservableList<Zapatilla> data = FXCollections.observableArrayList(
    	    ...
    	    new Zapatilla("ADIDAS Stan Smith", 16)
    ...
    private void initialize() {   
        ...
        Stock.setCellValueFactory(new PropertyValueFactory<Zapatilla,Integer>("Stock"));
